...
?>
	...
	<body>
		...
		<div id="main-contain" style="margin: auto;width: 50%">
			<h2>Change the inform</h2>
			<div class="form">
				<span style="font-size: 20px; color: red; font-style: italic"><b>Please fill in the form to change <?php echo $lop; ?> : </b> </span></br>
				</br>
				<form method="post" >
					<div class="form-group">
						<label>Class</label>
						<input type="text" class="form-control" name="ten" value="<?php echo $lop; ?>">
					</div>
					<div class="form-group">
						<label>Teacher's Name</label>
						<input type="text" class="form-control" name="GVCN" value="<?php echo $GVchunhiem; ?>">
					</div>
					<label >Class</label>
						...
						<button type="submit" class="btn btn-primary " name="sua" style="margin-top: 10px">Submit</button>
				</form>
				<br>
				<p>Chọn menu bên trái hoặc click vào <a href="./lop.php" style="color: blue; text-decoration:underline">đây</a> để quay lại danh sách lớp.</p>
				<br>
				<?php
				$link = new mysqli('localhost', 'root', '', 'sinhvien') or die('kết nối thất bại ');
				mysqli_query($link, 'SET NAMES UTF8');
