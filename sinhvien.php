...
?>
    ...
    margin-top: 2%;">Student List</h2><br>
			
				<form method="post" id="f_search" class="form-inline" style="margin-left: 73.3%;margin-bottom: 1%">
					<input class = "form-control"id="txtSearch" type="search" name="search" placeholder="Name or Student's id">
					<button class="btn btn-success" type="submit" id="btnSearch" name="tim" style="margin-left: 1%;">Search</button>
				</form>
				<div id="listSV" style="width:80%;margin: auto">
        <table class="table">
          <thead class="thead-dark">
			  ...
			  <th scope="col"> </th>
					...
					if (mysqli_num_rows($result) > 0) {
						...
						while ($r = mysqli_fetch_assoc($result)) {
							...
							echo "<td>$sdt</td>";
							echo "<td>$quequan</td>";
							echo " <td style='padding-left:0'> <a href='suasv.php?id=$sinhvienID'><button class='btn btn-primary'> Edit </button></a> <a href='xoasv.php?id=$sinhvienID'><button class='btn btn-danger'> Delete </button></a> <a href='thongtinsv.php?id=$sinhvienID'><button class='btn btn-info'> Detail</button></a>  </td>";
						}
					}
			...
			<br>
				<a href="themsv.php"><button class="btn btn-primary"  style="margin-left: 43%;">Add more student</button></a>
		</div>
